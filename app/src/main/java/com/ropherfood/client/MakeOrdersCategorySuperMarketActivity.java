...
public class MakeOrdersCategorySuperMarketActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_make_orders_category_super_market);
...
//                        displayAlertDialog(message);
    ...
    private void initialize() {
        ...
        recyclerView = findViewById(R.id.make_super_market_order_recyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        swipeRefreshLayout = findViewById(R.id.make_super_market_order_swipeRefreshLayout);

        list = new ArrayList<>();
        adapter = new MakeOrderAdapter(list);

        toolbar = findViewById(R.id.make_super_market_order_toolbar);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId() == R.id.cart_menu_item){
            startActivity(new Intent(MakeOrdersCategorySuperMarketActivity.this, CartActivity.class));
        }
